        ...
        I18N.registerLang('it', {
            'app.weather': 'Meteo',
            'weather.searchPlaceholder': 'Cerca una città...',
            'weather.useLocation': 'La mia posizione',
            'weather.locating': 'Localizzazione…',
            'weather.loading': 'Caricamento…',
            'weather.notFound': 'Nessuna città trovata',
            'weather.searchError': 'Ricerca non disponibile',
            'weather.locationError': 'Posizione non disponibile',
            'weather.error': 'Impossibile caricare il meteo',
            'weather.retry': 'Riprova',
            'weather.feelsLike': 'Percepita',
            'weather.humidity': 'Umidità',
            'weather.wind': 'Vento',
            'weather.forecast': 'Previsioni a 5 giorni',
            'weather.updated': 'Aggiornato alle {time}',
            'weather.today': 'Oggi',
            'weather.cond.clear': 'Cielo sereno',
            'weather.cond.mainlyClear': 'Prevalentemente sereno',
            'weather.cond.partlyCloudy': 'Parzialmente nuvoloso',
            'weather.cond.overcast': 'Coperto',
            'weather.cond.fog': 'Nebbia',
            'weather.cond.drizzle': 'Pioviggine',
            'weather.cond.freezingDrizzle': 'Pioviggine gelata',
            'weather.cond.rain': 'Pioggia',
            'weather.cond.freezingRain': 'Pioggia gelata',
            'weather.cond.snow': 'Neve',
            'weather.cond.snowGrains': 'Neve granulare',
            'weather.cond.rainShowers': 'Rovesci di pioggia',
            'weather.cond.snowShowers': 'Rovesci di neve',
            'weather.cond.thunderstorm': 'Temporale',
            'weather.cond.thunderstormHail': 'Temporale con grandine',
            'weather.cond.unknown': 'Condizioni sconosciute'
        });
        I18N.registerLang('pt', {
            'app.weather': 'Meteorologia',
            'weather.searchPlaceholder': 'Pesquisar uma cidade...',
            'weather.useLocation': 'A minha localização',
            'weather.locating': 'A localizar…',
            'weather.loading': 'A carregar…',
            'weather.notFound': 'Nenhuma cidade encontrada',
            'weather.searchError': 'Pesquisa indisponível',
            'weather.locationError': 'Localização indisponível',
            'weather.error': 'Não foi possível carregar o tempo',
            'weather.retry': 'Tentar novamente',
            'weather.feelsLike': 'Sensação térmica',
            'weather.humidity': 'Humidade',
            'weather.wind': 'Vento',
            'weather.forecast': 'Previsão para 5 dias',
            'weather.updated': 'Atualizado às {time}',
            'weather.today': 'Hoje',
            'weather.cond.clear': 'Céu limpo',
            'weather.cond.mainlyClear': 'Maioritariamente limpo',
            'weather.cond.partlyCloudy': 'Parcialmente nublado',
            'weather.cond.overcast': 'Encoberto',
            'weather.cond.fog': 'Nevoeiro',
            'weather.cond.drizzle': 'Chuvisco',
            'weather.cond.freezingDrizzle': 'Chuvisco gelado',
            'weather.cond.rain': 'Chuva',
            'weather.cond.freezingRain': 'Chuva gelada',
            'weather.cond.snow': 'Neve',
            'weather.cond.snowGrains': 'Grãos de neve',
            'weather.cond.rainShowers': 'Aguaceiros',
            'weather.cond.snowShowers': 'Aguaceiros de neve',
            'weather.cond.thunderstorm': 'Trovoada',
            'weather.cond.thunderstormHail': 'Trovoada com granizo',
            'weather.cond.unknown': 'Condições desconhecidas'
        });
