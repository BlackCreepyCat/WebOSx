      ...
      <div id="chat-statusbar">
        ...
        function __chatEngine() {
            ...
            function chatCopyCode() {
                ...
                function done() { el.textContent = 'Copié !'; setTimeout(function () { el.textContent = prev; }, 1200); }
            ...
            function fallbackCopy(text, el, prev) {
                ...
                try { document.execCommand('copy'); el.textContent = 'Copié !'; }
                catch (e) { el.textContent = 'Copie manuelle'; }
