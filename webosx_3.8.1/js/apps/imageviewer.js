        ...
        I18N.registerLang('it', {
            'imgv.toolbar.openExternal': 'Apri un file...',
            'imgv.toolbar.openVfs': 'Apri da I miei file...',
            'imgv.toolbar.zoomOut': 'Riduci',
            'imgv.toolbar.zoomIn': 'Ingrandisci',
            'imgv.toolbar.fit': 'Adatta alla finestra',
            'imgv.toolbar.zoom100': '100%',
            'imgv.toolbar.rotate': 'Ruota',
            'imgv.toolbar.download': 'Scarica',
            'imgv.pickerTitle': "Scegli un'immagine",
            'imgv.empty': 'Trascina qui un\'immagine, oppure usa il menu Apri',
            'imgv.loadError': 'Impossibile caricare questa immagine.'
        });
        I18N.registerLang('pt', {
            'imgv.toolbar.openExternal': 'Abrir um ficheiro...',
            'imgv.toolbar.openVfs': 'Abrir de Os meus ficheiros...',
            'imgv.toolbar.zoomOut': 'Diminuir zoom',
            'imgv.toolbar.zoomIn': 'Aumentar zoom',
            'imgv.toolbar.fit': 'Ajustar à janela',
            'imgv.toolbar.zoom100': '100%',
            'imgv.toolbar.rotate': 'Rodar',
            'imgv.toolbar.download': 'Transferir',
            'imgv.pickerTitle': 'Escolher uma imagem',
            'imgv.empty': 'Largue uma imagem aqui, ou use o menu Abrir',
            'imgv.loadError': 'Não é possível carregar esta imagem.'
        });
