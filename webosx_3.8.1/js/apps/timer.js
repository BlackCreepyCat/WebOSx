        ...
        I18N.registerLang('it', {
            'app.timer': 'Timer e Cronometro',
            'tsw.mode.timer': 'Timer', 'tsw.mode.stopwatch': 'Cronometro',
            'tsw.start': 'Avvia', 'tsw.pause': 'Pausa', 'tsw.reset': 'Reimposta', 'tsw.lap': 'Giro',
            'tsw.running': 'In corso', 'tsw.paused': 'In pausa', 'tsw.ready': 'Pronto', 'tsw.done': 'Terminato!',
            'tsw.notifyDone': 'Il timer è terminato.', 'tsw.customPlaceholderMin': 'min', 'tsw.customPlaceholderSec': 'sec', 'tsw.set': 'Imposta'
        });
        I18N.registerLang('pt', {
            'app.timer': 'Temporizador e Cronómetro',
            'tsw.mode.timer': 'Temporizador', 'tsw.mode.stopwatch': 'Cronómetro',
            'tsw.start': 'Iniciar', 'tsw.pause': 'Pausar', 'tsw.reset': 'Repor', 'tsw.lap': 'Volta',
            'tsw.running': 'Em curso', 'tsw.paused': 'Em pausa', 'tsw.ready': 'Pronto', 'tsw.done': 'Concluído!',
            'tsw.notifyDone': 'O temporizador terminou.', 'tsw.customPlaceholderMin': 'min', 'tsw.customPlaceholderSec': 'seg', 'tsw.set': 'Definir'
        });
