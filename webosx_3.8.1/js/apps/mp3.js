        ...
        I18N.registerLang('it', {
            'mp3.dropHint': 'Trascina qui i tuoi file audio',
            'mp3.noTrack': 'Nessun brano',
            'mp3.addMusicHint': 'Aggiungi musica per iniziare',
            'mp3.shuffle': 'Casuale',
            'mp3.previous': 'Precedente',
            'mp3.playPause': 'Riproduci/Pausa',
            'mp3.next': 'Successivo',
            'mp3.repeat': 'Ripeti',
            'mp3.playlist': 'Playlist',
            'mp3.add': '+ Aggiungi',
            'mp3.addFromFiles': 'Da I miei file...',
            'mp3.addFromComputer': 'Dal mio computer...',
            'mp3.clear': 'Svuota',
            'mp3.emptyPlaylist': 'Nessun brano. Fai clic su "+ Aggiungi" per importare file audio.',
            'mp3.remove': 'Rimuovi',
            'mp3.unknownArtist': 'Artista sconosciuto'
        });
        I18N.registerLang('pt', {
            'mp3.dropHint': 'Largue aqui os seus ficheiros de áudio',
            'mp3.noTrack': 'Sem faixa',
            'mp3.addMusicHint': 'Adicione música para começar',
            'mp3.shuffle': 'Aleatório',
            'mp3.previous': 'Anterior',
            'mp3.playPause': 'Reproduzir/Pausar',
            'mp3.next': 'Seguinte',
            'mp3.repeat': 'Repetir',
            'mp3.playlist': 'Lista de reprodução',
            'mp3.add': '+ Adicionar',
            'mp3.addFromFiles': 'De Os meus ficheiros...',
            'mp3.addFromComputer': 'Do meu computador...',
            'mp3.clear': 'Limpar',
            'mp3.emptyPlaylist': 'Sem faixas. Clique em "+ Adicionar" para importar ficheiros de áudio.',
            'mp3.remove': 'Remover',
            'mp3.unknownArtist': 'Artista desconhecido'
        });
