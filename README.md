...
With the upcoming control and surveillance measures, I thought that tools like this, where anyone can be a server anywhere, without software to install, even on a androit tv? a raspberry (create a files server in a browser tab!)? or a mobile phone / tablet (I’ve tested it! with a mouse connected to my samsung) could be helpful in the future for temporary flash files transfert and chatrooms... Besides, I do whatever i want! :)
