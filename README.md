...
With the upcoming control and surveillance measures, I thought that tools like this, where anyone can be a server anywhere, without software to install, even on a mobile phone or a tablet (I’ve tested it!) could be helpful in the future for files transfert and chatrooms... Besides, I do whatever i want! :)
