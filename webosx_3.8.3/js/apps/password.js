// ==================================================================
        ...
        I18N.registerLang('fr', {
            ...
            'pwd.excludeAmbiguous': 'Exclure ambigus',
            'pwd.excludeAmbiguousDetail': 'Exclure les caractères ambigus (0, O, 1, l, I)',
            'pwd.copy': 'Copier',
            'pwd.copied': 'Copié !',
        ...
        I18N.registerLang('en', {
            ...
            'pwd.symbols': 'Symbols (!@#$...)',
            'pwd.excludeAmbiguous': 'Exclude ambiguous',
            'pwd.excludeAmbiguousDetail': 'Exclude ambiguous characters (0, O, 1, l, I)',
            'pwd.copy': 'Copy',
            'pwd.copied': 'Copied!',
        ...
        I18N.registerLang('es', {
            ...
            'pwd.excludeAmbiguous': 'Excluir ambiguos',
            'pwd.excludeAmbiguousDetail': 'Excluir caracteres ambiguos (0, O, 1, l, I)',
            'pwd.copy': 'Copiar',
            'pwd.copied': '¡Copiado!',
        ...
        I18N.registerLang('de', {
            ...
            'pwd.excludeAmbiguous': 'Mehrdeutige ausschließen',
            'pwd.excludeAmbiguousDetail': 'Mehrdeutige Zeichen ausschließen (0, O, 1, l, I)',
            'pwd.copy': 'Kopieren',
            'pwd.copied': 'Kopiert!',
        ...
        I18N.registerLang('it', {
            'app.pwgen': 'Generatore di password',
            'pwd.length': 'Lunghezza',
            'pwd.uppercase': 'Maiuscole (A-Z)',
            'pwd.lowercase': 'Minuscole (a-z)',
            'pwd.numbers': 'Numeri (0-9)',
            'pwd.symbols': 'Simboli (!@#$...)',
            'pwd.excludeAmbiguous': 'Escludi ambigui',
            'pwd.excludeAmbiguousDetail': 'Escludi i caratteri ambigui (0, O, 1, l, I)',
            'pwd.copy': 'Copia',
            'pwd.copied': 'Copiato!',
            'pwd.regenerate': 'Rigenera',
            'pwd.selectAtLeastOne': 'Seleziona almeno un tipo di carattere',
            'pwd.entropyBits': '{bits} bit di entropia',
            'pwd.strength.veryWeak': 'Molto debole',
            'pwd.strength.weak': 'Debole',
            'pwd.strength.fair': 'Discreta',
            'pwd.strength.strong': 'Forte',
            'pwd.strength.veryStrong': 'Molto forte'
        });
        I18N.registerLang('pt', {
            'app.pwgen': 'Gerador de palavras-passe',
            'pwd.length': 'Comprimento',
            'pwd.uppercase': 'Maiúsculas (A-Z)',
            'pwd.lowercase': 'Minúsculas (a-z)',
            'pwd.numbers': 'Números (0-9)',
            'pwd.symbols': 'Símbolos (!@#$...)',
            'pwd.excludeAmbiguous': 'Excluir ambíguos',
            'pwd.excludeAmbiguousDetail': 'Excluir caracteres ambíguos (0, O, 1, l, I)',
            'pwd.copy': 'Copiar',
            'pwd.copied': 'Copiado!',
            'pwd.regenerate': 'Regenerar',
            'pwd.selectAtLeastOne': 'Selecione pelo menos um tipo de carácter',
            'pwd.entropyBits': '{bits} bits de entropia',
            'pwd.strength.veryWeak': 'Muito fraca',
            'pwd.strength.weak': 'Fraca',
            'pwd.strength.fair': 'Razoável',
            'pwd.strength.strong': 'Forte',
            'pwd.strength.veryStrong': 'Muito forte'
        });
        ...
        OS.registry.register({
            ...
            init: (c, api) => {
                    ...
                    <div class="pwd-scroll">
                        ...
                        <div class="settings-container" style="gap:16px;">
                            ...
                            <div class="setting-group">
                                ...
                                <div class="setting-row"><span class="setting-label" id="pwd-lbl-ambiguous"></span>
                ...
                function relocalize() {
                    ...
                    const lblAmbiguous = c.querySelector('#pwd-lbl-ambiguous');
                    lblAmbiguous.textContent = I18N.t('pwd.excludeAmbiguous');
                    lblAmbiguous.title = I18N.t('pwd.excludeAmbiguousDetail');
