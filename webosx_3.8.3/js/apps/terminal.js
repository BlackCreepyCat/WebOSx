        ...
        I18N.registerLang('it', {
            'term.subtitle': 'Terminale di rete — strumenti web live. Digita "help" per l\'elenco dei comandi.',
            'term.help.header': 'Comandi disponibili:',
            'term.help.help': 'Mostra questo aiuto',
            'term.help.clear': 'Pulisce lo schermo',
            'term.help.echo': 'Mostra del testo',
            'term.help.myip': 'Mostra il mio IP pubblico + geolocalizzazione',
            'term.help.geoip': 'Geolocalizza un indirizzo IP',
            'term.help.dns': 'Risolve un record DNS (A, AAAA, MX, TXT, NS...)',
            'term.help.whois': 'Informazioni di registrazione del dominio (RDAP)',
            'term.help.ping': 'Latenza approssimativa verso un host',
            'term.help.useragent': 'Informazioni su browser / dispositivo',
            'term.help.theme': "Cambia la tonalità dell'accento (0-360)",
            'term.network.fail': 'richiesta di rete non riuscita ({err})',
            'term.network.noConn': 'connessione non disponibile',
            'term.myip.searching': 'Ricerca IP pubblico in corso...',
            'term.myip.labelIPv4': 'IP pubblico (IPv4):',
            'term.label.city': 'Città:',
            'term.label.isp': 'Provider:',
            'term.label.coords': 'Coordinate:',
            'term.label.tz': 'Fuso orario:',
            'term.myip.geoUnavailable': '(geolocalizzazione non disponibile)',
            'term.myip.ipifyFail': '(ipify non disponibile: {err}, tentativo alternativo...)',
            'term.myip.labelGeneric': 'IP pubblico{v6}:',
            'term.myip.ipv6Suffix': ' (IPv6)',
            'term.myip.fetchFail': "Errore: impossibile recuperare l'IP pubblico ({err}).",
            'term.fileHint': 'Suggerimento: questo file è aperto localmente (file://). Alcuni browser bloccano le richieste di rete in uscita in questa modalità. Prova a servirlo tramite un piccolo server locale (es. "python -m http.server") oppure ospitalo online.',
            'term.myip.ipv6Note': 'Nota: indirizzo in formato IPv6 (contiene ":"), normale se la tua connessione usa IPv6 — non assomiglierà a "192.xx.xx.xx".',
            'term.geoip.usage': 'Utilizzo: geoip [indirizzo-ip]',
            'term.geoip.searching': 'Geolocalizzazione di {ip} in corso...',
            'term.error': 'Errore: {err}',
            'term.label.country': 'Paese:',
            'term.label.region': 'Regione:',
            'term.label.ispShort': 'ISP:',
            'term.label.asn': 'ASN:',
            'term.unknown': 'sconosciuto',
            'term.dns.usage': 'Utilizzo: dns [dominio] [tipo=A|AAAA|MX|TXT|NS|CNAME|SOA]',
            'term.dns.resolving': 'Risoluzione DNS {type} per {domain}...',
            'term.dns.none': 'Nessun record {type} trovato per {domain}.',
            'term.dns.records': 'Record {type} per {domain}:',
            'term.dns.error': 'Errore DNS: {err}',
            'term.whois.usage': 'Utilizzo: whois [dominio]',
            'term.whois.querying': 'Interrogazione RDAP per {domain}...',
            'term.label.domain': 'Dominio:',
            'term.label.status': 'Stato:',
            'term.label.registrar': 'Registrar:',
            'term.label.created': 'Creato il:',
            'term.label.expires': 'Scade il:',
            'term.label.nameservers': 'Nameserver:',
            'term.whois.error': 'Errore WHOIS: dominio non trovato o non supportato ({err})',
            'term.ping.usage': 'Utilizzo: ping [dominio]',
            'term.ping.pinging': 'Ping a {host} (via HTTPS)...',
            'term.ping.response': 'Risposta da {host}: tempo={ms}ms',
            'term.ping.noResponse': 'Nessuna risposta (host irraggiungibile o bloccato da CORS)',
            'term.ping.stats': 'Statistiche:',
            'term.ping.notifyFail': 'Ping a {host} non riuscito',
            'term.ua.label': 'User-Agent:',
            'term.ua.platform': 'Piattaforma:',
            'term.ua.lang': 'Lingua:',
            'term.ua.resolution': 'Risoluzione:',
            'term.ua.cores': 'Core CPU:',
            'term.ua.online': 'Online:',
            'term.yes': 'sì',
            'term.no': 'no',
            'term.theme.changed': 'Tonalità cambiata a {hue}°',
            'term.theme.usage': 'Utilizzo: theme [0-360]',
            'term.unknownCmd': 'Comando sconosciuto: {cmd}',
            'term.helpHint': 'Digita "help" per assistenza.',
            'term.help.base64': 'Codifica / decodifica testo in Base64',
            'term.help.hash': 'Digest SHA-1 / SHA-256 di un testo',
            'term.help.jwt': 'Decodifica un token JWT (header + payload)',
            'term.help.uuid': 'Genera uno o più UUID v4',
            'term.help.json': 'Formatta o minifica JSON',
            'term.help.color': 'Converte un colore (hex / rgb / hsl)',
            'term.help.calc': 'Valuta un\'espressione matematica',
            'term.help.base': 'Converte un numero tra basi numeriche',
            'term.help.httpstatus': 'Significato di un codice di stato HTTP',
            'term.base64.usage': 'Utilizzo: base64 encode|decode [testo]',
            'term.base64.error': 'Errore: stringa Base64 non valida',
            'term.hash.usage': 'Utilizzo: hash sha1|sha256 [testo]',
            'term.hash.unsupported': 'Algoritmo non supportato (solo sha1, sha256)',
            'term.hash.unavailable': 'Web Crypto non disponibile (richiede un contesto sicuro: https:// o localhost)',
            'term.jwt.usage': 'Utilizzo: jwt [token]',
            'term.jwt.invalid': 'Token JWT non valido',
            'term.jwt.warning': '⚠ Firma non verificata — solo visualizzazione del contenuto',
            'term.jwt.header': 'Header:',
            'term.jwt.payload': 'Payload:',
            'term.json.usage': 'Utilizzo: json format|minify [json]',
            'term.json.invalid': 'JSON non valido: {err}',
            'term.color.usage': 'Utilizzo: color [#hex | rgb(...) | hsl(...)]',
            'term.color.invalid': 'Formato colore non riconosciuto',
            'term.color.hex': 'Hex:',
            'term.color.rgb': 'RGB:',
            'term.color.hsl': 'HSL:',
            'term.calc.usage': 'Utilizzo: calc [espressione]',
            'term.calc.error': 'Errore: {err}',
            'term.base.usage': 'Utilizzo: base [numero] [da] [a]  (bin|oct|dec|hex oppure 2-36)',
            'term.base.invalidBase': 'Base non valida: {b}',
            'term.base.invalidNumber': 'Numero non valido per la base {b}',
            'term.httpstatus.usage': 'Utilizzo: httpstatus [codice]',
            'term.httpstatus.unknown': 'Codice sconosciuto: {code}',
            'term.help.wordcount': 'Conta parole, caratteri e tempo di lettura',
            'term.help.case': 'Trasforma il case: upper/lower/title/camel/snake',
            'term.help.moyenne': 'Media ponderata (voto:peso,voto:peso,...)',
            'term.help.ohm': "Legge di Ohm — imposta _ sul valore da calcolare",
            'term.help.pythagore': 'Ipotenusa di un triangolo rettangolo',
            'term.wordcount.usage': 'Utilizzo: wordcount [testo]',
            'term.wordcount.words': 'Parole:',
            'term.wordcount.chars': 'Caratteri:',
            'term.wordcount.charsNoSpace': 'senza spazi',
            'term.wordcount.readTime': 'Tempo di lettura stimato:',
            'term.case.usage': 'Utilizzo: case upper|lower|title|camel|snake [testo]',
            'term.moyenne.usage': 'Utilizzo: moyenne voto:peso,voto:peso,...  (peso opzionale, predefinito 1)',
            'term.moyenne.invalid': 'Formato non valido: {p}',
            'term.moyenne.zeroCoef': 'La somma dei pesi è zero',
            'term.moyenne.result': 'Media: {avg} / 20  ({n} voti, peso totale {coef})',
            'term.ohm.usage': "Utilizzo: ohm [V] [I] [R]  (imposta _ sul valore da calcolare)",
            'term.ohm.needOneUnknown': 'Specifica esattamente un parametro sconosciuto con _',
            'term.ohm.invalidNumber': 'Valore numerico non valido',
            'term.pythagore.usage': 'Utilizzo: pythagore [lato a] [lato b]',
            'term.pythagore.invalid': 'Entrambi i lati devono essere numeri positivi',
            'term.pythagore.result': 'Ipotenusa: {c}',
            'term.help.cidr': 'Calcolatore di sottoreti (rete, broadcast, intervallo host)',
            'term.help.ports': 'Cerca una porta nota (numero o servizio)',
            'term.help.secheaders': 'Verifica gli header di sicurezza HTTP di un URL',
            'term.cidr.usage': 'Utilizzo: cidr [ip]/[prefisso]  (es. cidr 192.168.1.10/24)',
            'term.cidr.invalid': 'Indirizzo IP o prefisso non valido',
            'term.cidr.network': 'Rete:',
            'term.cidr.broadcast': 'Broadcast:',
            'term.cidr.mask': 'Maschera:',
            'term.cidr.wildcard': 'Maschera wildcard:',
            'term.cidr.hosts': 'Host utilizzabili:',
            'term.cidr.range': 'Intervallo:',
            'term.ports.usage': 'Utilizzo: ports [numero o nome servizio]',
            'term.ports.none': 'Nessuna corrispondenza trovata',
            'term.secheaders.usage': 'Utilizzo: secheaders [url]',
            'term.secheaders.checking': 'Verifica di {url} in corso...',
            'term.secheaders.missing': '(mancante)',
            'term.secheaders.error': 'Errore: {err} (spesso un blocco CORS del sito di destinazione)',
            'term.help.pwd': 'Mostra la directory corrente',
            'term.help.ls': 'Elenca il contenuto della directory',
            'term.help.cd': 'Cambia directory',
            'term.help.mkdir': 'Crea una directory',
            'term.help.touch': 'Crea un file vuoto',
            'term.help.cat': "Mostra il contenuto di un file di testo",
            'term.help.echoRedirect': 'Mostra del testo (o scrivi in un file con > / >>)',
            'term.help.rm': 'Elimina un file (o -r per una directory)',
            'term.help.rmdir': 'Elimina una directory vuota',
            'term.help.mv': 'Sposta / rinomina un file o una directory',
            'term.help.cp': 'Copia un file o una directory',
            'term.help.tree': "Mostra l'albero delle directory",
            'term.help.find': 'Cerca un file/directory per nome',
            'term.fs.notFound': 'Non trovato: {name}',
            'term.fs.notDir': 'Non è una directory: {name}',
            'term.fs.isDir': 'È una directory: {name}',
            'term.fs.empty': '(vuoto)',
            'term.fs.exists': 'Questo nome esiste già: {name}',
            'term.fs.notEmpty': 'Directory non vuota (usa rm -r)',
            'term.fs.binary': 'File binario — usa l\'app I miei file per scaricarlo',
            'term.fs.quota': 'Spazio di archiviazione locale pieno — libera spazio',
            'term.fs.tooLarge': 'File troppo grande (max {max})',
            'term.fs.rootProtected': 'Impossibile rimuovere/spostare la directory radice',
            'term.fs.ok': '✓',
            'term.pwd.usage': '',
            'term.ls.usage': 'Utilizzo: ls [directory]',
            'term.cd.usage': 'Utilizzo: cd [directory]',
            'term.mkdir.usage': 'Utilizzo: mkdir [nome]',
            'term.touch.usage': 'Utilizzo: touch [nome]',
            'term.cat.usage': 'Utilizzo: cat [file]',
            'term.rm.usage': 'Utilizzo: rm [-r] [file|directory]',
            'term.rmdir.usage': 'Utilizzo: rmdir [directory]',
            'term.mv.usage': 'Utilizzo: mv [origine] [destinazione]',
            'term.cp.usage': 'Utilizzo: cp [origine] [destinazione]',
            'term.tree.usage': '',
            'term.find.usage': 'Utilizzo: find [pattern]',
            'term.find.none': 'Nessun risultato per "{pattern}"',
            'term.fileWarning': '⚠ File aperto localmente (file://): alcuni browser limitano le richieste di rete in uscita in questa modalità. Se "myip", "dns", "whois" o "ping" non funzionano, prova a servire questo file tramite un server locale (es. "python -m http.server") oppure ospitalo online.'
        });
        I18N.registerLang('pt', {
            'term.subtitle': 'Terminal de rede — ferramentas web em direto. Digite "help" para a lista de comandos.',
            'term.help.header': 'Comandos disponíveis:',
            'term.help.help': 'Mostra esta ajuda',
            'term.help.clear': 'Limpa o ecrã',
            'term.help.echo': 'Mostra texto',
            'term.help.myip': 'Mostra o meu IP público + geolocalização',
            'term.help.geoip': 'Geolocaliza um endereço IP',
            'term.help.dns': 'Resolve um registo DNS (A, AAAA, MX, TXT, NS...)',
            'term.help.whois': 'Informações de registo do domínio (RDAP)',
            'term.help.ping': 'Latência aproximada até um anfitrião',
            'term.help.useragent': 'Informações do navegador / máquina',
            'term.help.theme': 'Muda o tom de destaque (0-360)',
            'term.network.fail': 'pedido de rede falhou ({err})',
            'term.network.noConn': 'ligação indisponível',
            'term.myip.searching': 'A procurar IP público...',
            'term.myip.labelIPv4': 'IP público (IPv4):',
            'term.label.city': 'Cidade:',
            'term.label.isp': 'Fornecedor:',
            'term.label.coords': 'Coordenadas:',
            'term.label.tz': 'Fuso horário:',
            'term.myip.geoUnavailable': '(geolocalização indisponível)',
            'term.myip.ipifyFail': '(ipify indisponível: {err}, a tentar alternativa...)',
            'term.myip.labelGeneric': 'IP público{v6}:',
            'term.myip.ipv6Suffix': ' (IPv6)',
            'term.myip.fetchFail': 'Erro: não foi possível obter o IP público ({err}).',
            'term.fileHint': 'Dica: este ficheiro está aberto localmente (file://). Alguns navegadores bloqueiam pedidos de rede de saída neste modo. Tente servi-lo através de um pequeno servidor local (ex.: "python -m http.server") ou alojá-lo online.',
            'term.myip.ipv6Note': 'Nota: endereço em formato IPv6 (contém ":"), normal se a sua ligação usar IPv6 — não terá o aspeto de "192.xx.xx.xx".',
            'term.geoip.usage': 'Utilização: geoip [endereço-ip]',
            'term.geoip.searching': 'A geolocalizar {ip}...',
            'term.error': 'Erro: {err}',
            'term.label.country': 'País:',
            'term.label.region': 'Região:',
            'term.label.ispShort': 'ISP:',
            'term.label.asn': 'ASN:',
            'term.unknown': 'desconhecido',
            'term.dns.usage': 'Utilização: dns [domínio] [tipo=A|AAAA|MX|TXT|NS|CNAME|SOA]',
            'term.dns.resolving': 'A resolver DNS {type} para {domain}...',
            'term.dns.none': 'Nenhum registo {type} encontrado para {domain}.',
            'term.dns.records': 'Registos {type} para {domain}:',
            'term.dns.error': 'Erro DNS: {err}',
            'term.whois.usage': 'Utilização: whois [domínio]',
            'term.whois.querying': 'Consulta RDAP para {domain}...',
            'term.label.domain': 'Domínio:',
            'term.label.status': 'Estado:',
            'term.label.registrar': 'Registrar:',
            'term.label.created': 'Criado em:',
            'term.label.expires': 'Expira em:',
            'term.label.nameservers': 'Servidores de nomes:',
            'term.whois.error': 'Erro WHOIS: domínio não encontrado ou não suportado ({err})',
            'term.ping.usage': 'Utilização: ping [domínio]',
            'term.ping.pinging': 'A fazer ping a {host} (via HTTPS)...',
            'term.ping.response': 'Resposta de {host}: tempo={ms}ms',
            'term.ping.noResponse': 'Sem resposta (anfitrião inacessível ou bloqueado por CORS)',
            'term.ping.stats': 'Estatísticas:',
            'term.ping.notifyFail': 'Ping a {host} falhou',
            'term.ua.label': 'User-Agent:',
            'term.ua.platform': 'Plataforma:',
            'term.ua.lang': 'Idioma:',
            'term.ua.resolution': 'Resolução:',
            'term.ua.cores': 'Núcleos de CPU:',
            'term.ua.online': 'Online:',
            'term.yes': 'sim',
            'term.no': 'não',
            'term.theme.changed': 'Tom alterado para {hue}°',
            'term.theme.usage': 'Utilização: theme [0-360]',
            'term.unknownCmd': 'Comando desconhecido: {cmd}',
            'term.helpHint': 'Digite "help" para assistência.',
            'term.help.base64': 'Codifica / descodifica texto em Base64',
            'term.help.hash': 'Digest SHA-1 / SHA-256 de um texto',
            'term.help.jwt': 'Descodifica um token JWT (cabeçalho + payload)',
            'term.help.uuid': 'Gera um ou mais UUID v4',
            'term.help.json': 'Formata ou minifica JSON',
            'term.help.color': 'Converte uma cor (hex / rgb / hsl)',
            'term.help.calc': 'Avalia uma expressão matemática',
            'term.help.base': 'Converte um número entre bases numéricas',
            'term.help.httpstatus': 'Significado de um código de estado HTTP',
            'term.base64.usage': 'Utilização: base64 encode|decode [texto]',
            'term.base64.error': 'Erro: cadeia Base64 inválida',
            'term.hash.usage': 'Utilização: hash sha1|sha256 [texto]',
            'term.hash.unsupported': 'Algoritmo não suportado (apenas sha1, sha256)',
            'term.hash.unavailable': 'Web Crypto indisponível (requer um contexto seguro: https:// ou localhost)',
            'term.jwt.usage': 'Utilização: jwt [token]',
            'term.jwt.invalid': 'Token JWT inválido',
            'term.jwt.warning': '⚠ Assinatura não verificada — apenas visualização do conteúdo',
            'term.jwt.header': 'Cabeçalho:',
            'term.jwt.payload': 'Payload:',
            'term.json.usage': 'Utilização: json format|minify [json]',
            'term.json.invalid': 'JSON inválido: {err}',
            'term.color.usage': 'Utilização: color [#hex | rgb(...) | hsl(...)]',
            'term.color.invalid': 'Formato de cor não reconhecido',
            'term.color.hex': 'Hex:',
            'term.color.rgb': 'RGB:',
            'term.color.hsl': 'HSL:',
            'term.calc.usage': 'Utilização: calc [expressão]',
            'term.calc.error': 'Erro: {err}',
            'term.base.usage': 'Utilização: base [número] [de] [para]  (bin|oct|dec|hex ou 2-36)',
            'term.base.invalidBase': 'Base inválida: {b}',
            'term.base.invalidNumber': 'Número inválido para a base {b}',
            'term.httpstatus.usage': 'Utilização: httpstatus [código]',
            'term.httpstatus.unknown': 'Código desconhecido: {code}',
            'term.help.wordcount': 'Conta palavras, caracteres e tempo de leitura',
            'term.help.case': 'Transforma o case: upper/lower/title/camel/snake',
            'term.help.moyenne': 'Média ponderada (nota:peso,nota:peso,...)',
            'term.help.ohm': 'Lei de Ohm — defina _ no valor a calcular',
            'term.help.pythagore': 'Hipotenusa de um triângulo retângulo',
            'term.wordcount.usage': 'Utilização: wordcount [texto]',
            'term.wordcount.words': 'Palavras:',
            'term.wordcount.chars': 'Caracteres:',
            'term.wordcount.charsNoSpace': 'sem espaços',
            'term.wordcount.readTime': 'Tempo de leitura estimado:',
            'term.case.usage': 'Utilização: case upper|lower|title|camel|snake [texto]',
            'term.moyenne.usage': 'Utilização: moyenne nota:peso,nota:peso,...  (peso opcional, padrão 1)',
            'term.moyenne.invalid': 'Formato inválido: {p}',
            'term.moyenne.zeroCoef': 'A soma dos pesos é zero',
            'term.moyenne.result': 'Média: {avg} / 20  ({n} notas, peso total {coef})',
            'term.ohm.usage': 'Utilização: ohm [V] [I] [R]  (defina _ no valor a calcular)',
            'term.ohm.needOneUnknown': 'Especifique exatamente um parâmetro desconhecido com _',
            'term.ohm.invalidNumber': 'Valor numérico inválido',
            'term.pythagore.usage': 'Utilização: pythagore [lado a] [lado b]',
            'term.pythagore.invalid': 'Ambos os lados devem ser números positivos',
            'term.pythagore.result': 'Hipotenusa: {c}',
            'term.help.cidr': 'Calculadora de sub-redes (rede, broadcast, intervalo de anfitriões)',
            'term.help.ports': 'Procura uma porta conhecida (número ou serviço)',
            'term.help.secheaders': 'Verifica os cabeçalhos de segurança HTTP de um URL',
            'term.cidr.usage': 'Utilização: cidr [ip]/[prefixo]  (ex.: cidr 192.168.1.10/24)',
            'term.cidr.invalid': 'Endereço IP ou prefixo inválido',
            'term.cidr.network': 'Rede:',
            'term.cidr.broadcast': 'Broadcast:',
            'term.cidr.mask': 'Máscara:',
            'term.cidr.wildcard': 'Máscara wildcard:',
            'term.cidr.hosts': 'Anfitriões utilizáveis:',
            'term.cidr.range': 'Intervalo:',
            'term.ports.usage': 'Utilização: ports [número ou nome do serviço]',
            'term.ports.none': 'Nenhuma correspondência encontrada',
            'term.secheaders.usage': 'Utilização: secheaders [url]',
            'term.secheaders.checking': 'A verificar {url}...',
            'term.secheaders.missing': '(em falta)',
            'term.secheaders.error': 'Erro: {err} (frequentemente um bloqueio CORS do site de destino)',
            'term.help.pwd': 'Mostra a diretoria atual',
            'term.help.ls': 'Lista o conteúdo da diretoria',
            'term.help.cd': 'Muda de diretoria',
            'term.help.mkdir': 'Cria uma diretoria',
            'term.help.touch': 'Cria um ficheiro vazio',
            'term.help.cat': 'Mostra o conteúdo de um ficheiro de texto',
            'term.help.echoRedirect': 'Mostra texto (ou escreve num ficheiro com > / >>)',
            'term.help.rm': 'Elimina um ficheiro (ou -r para uma diretoria)',
            'term.help.rmdir': 'Elimina uma diretoria vazia',
            'term.help.mv': 'Move / renomeia um ficheiro ou diretoria',
            'term.help.cp': 'Copia um ficheiro ou diretoria',
            'term.help.tree': 'Mostra a árvore de diretorias',
            'term.help.find': 'Procura um ficheiro/diretoria por nome',
            'term.fs.notFound': 'Não encontrado: {name}',
            'term.fs.notDir': 'Não é uma diretoria: {name}',
            'term.fs.isDir': 'É uma diretoria: {name}',
            'term.fs.empty': '(vazio)',
            'term.fs.exists': 'Esse nome já existe: {name}',
            'term.fs.notEmpty': 'Diretoria não vazia (use rm -r)',
            'term.fs.binary': 'Ficheiro binário — use a aplicação Os meus ficheiros para o transferir',
            'term.fs.quota': 'Armazenamento local cheio — liberte espaço',
            'term.fs.tooLarge': 'Ficheiro demasiado grande (máx. {max})',
            'term.fs.rootProtected': 'Não é possível remover/mover a diretoria raiz',
            'term.fs.ok': '✓',
            'term.pwd.usage': '',
            'term.ls.usage': 'Utilização: ls [diretoria]',
            'term.cd.usage': 'Utilização: cd [diretoria]',
            'term.mkdir.usage': 'Utilização: mkdir [nome]',
            'term.touch.usage': 'Utilização: touch [nome]',
            'term.cat.usage': 'Utilização: cat [ficheiro]',
            'term.rm.usage': 'Utilização: rm [-r] [ficheiro|diretoria]',
            'term.rmdir.usage': 'Utilização: rmdir [diretoria]',
            'term.mv.usage': 'Utilização: mv [origem] [destino]',
            'term.cp.usage': 'Utilização: cp [origem] [destino]',
            'term.tree.usage': '',
            'term.find.usage': 'Utilização: find [padrão]',
            'term.find.none': 'Nenhum resultado para "{pattern}"',
            'term.fileWarning': '⚠ Ficheiro aberto localmente (file://): alguns navegadores restringem pedidos de rede de saída neste modo. Se "myip", "dns", "whois" ou "ping" falharem, tente servir este ficheiro através de um servidor local (ex.: "python -m http.server") ou alojá-lo online.'
        });
        ...
        OS.registry.register({
            ...
            init: (c, api) => {
                ...
                // --- Localisation live : les commandes futures (help, erreurs, etc.)
                // appellent déjà I18N.t() au moment de leur exécution et suivent donc
                // automatiquement un changement de langue. Seule la bannière d'accueil,
                // imprimée une fois à l'ouverture, doit être retraduite explicitement.
                function relocalize() {
                    const subtitleEl = c.querySelector('#term-subtitle');
                    if (subtitleEl) subtitleEl.textContent = I18N.t('term.subtitle');
                }
