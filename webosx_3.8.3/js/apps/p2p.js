        ...
        I18N.registerLang('fr', {
            ...
            "p2p.notify.receiverConnected": "Receveur connecté",
            "p2p.notify.receiverDisconnected": "Receveur déconnecté",
            "p2p.notify.connected": "Connecté à l'envoyeur",
            "p2p.notify.disconnected": "Connexion à l'envoyeur perdue",
            "p2p.notify.serverJoined": "Receveur #{n} connecté",
            "p2p.notify.serverLeft": "Receveur #{n} déconnecté",
        ...
        I18N.registerLang('en', {
            ...
            "p2p.notify.receiverConnected": "Receiver connected",
            "p2p.notify.receiverDisconnected": "Receiver disconnected",
            "p2p.notify.connected": "Connected to sender",
            "p2p.notify.disconnected": "Lost connection to sender",
            "p2p.notify.serverJoined": "Receiver #{n} connected",
            "p2p.notify.serverLeft": "Receiver #{n} disconnected",
        ...
        I18N.registerLang('es', {
            ...
            "p2p.notify.receiverConnected": "Receptor conectado",
            "p2p.notify.receiverDisconnected": "Receptor desconectado",
            "p2p.notify.connected": "Conectado al emisor",
            "p2p.notify.disconnected": "Conexión con el emisor perdida",
            "p2p.notify.serverJoined": "Receptor #{n} conectado",
            "p2p.notify.serverLeft": "Receptor #{n} desconectado",
        ...
        I18N.registerLang('de', {
            ...
            "p2p.notify.receiverConnected": "Empfänger verbunden",
            "p2p.notify.receiverDisconnected": "Empfänger getrennt",
            "p2p.notify.connected": "Mit Absender verbunden",
            "p2p.notify.disconnected": "Verbindung zum Absender verloren",
            "p2p.notify.serverJoined": "Empfänger #{n} verbunden",
            "p2p.notify.serverLeft": "Empfänger #{n} getrennt",
        ...
        I18N.registerLang('it', {
            "app.p2p": "Trasferimento P2P",
            "p2p.notify.receiverConnected": "Destinatario connesso",
            "p2p.notify.receiverDisconnected": "Destinatario disconnesso",
            "p2p.notify.connected": "Connesso al mittente",
            "p2p.notify.disconnected": "Connessione al mittente persa",
            "p2p.notify.serverJoined": "Destinatario #{n} connesso",
            "p2p.notify.serverLeft": "Destinatario #{n} disconnesso",
            "p2p.role.title": "SELEZIONA MODALITÀ",
            "p2p.role.subtitle": "WebRTC diretto · Nessun server · Nessun limite di caricamento",
            "p2p.role.send.label": "Invia",
            "p2p.role.send.desc": "Condividi file direttamente con un peer",
            "p2p.role.receive.label": "Ricevi",
            "p2p.role.receive.desc": "Scarica da un mittente o da un server",
            "p2p.role.server.label": "Server",
            "p2p.role.server.desc": "Ospita una libreria di file per più peer",
            "p2p.role.hint": "Passa il mouse o tocca una modalità per i dettagli · Clicca per iniziare",
            "p2p.role.loading": "Caricamento motore P2P…",
            "p2p.role.edgeStrong": "Microsoft Edge consigliato",
            "p2p.role.edgeDesc": " — Edge supporta la File System Access API, che consente di salvare i file ricevuti direttamente in una cartella scelta, senza finestre di dialogo per ogni file. Gli altri browser useranno il download classico per singolo file.",
            "p2p.common.shaTooltipSend": "Verifica l'integrità del file tramite hash SHA-256",
            "p2p.common.shaTooltipSrv": "Calcola e invia l'hash SHA-256 ai destinatari per la verifica dell'integrità",
            "p2p.table.name": "Nome",
            "p2p.table.size": "Dimensione",
            "p2p.table.status": "Stato",
            "p2p.table.hash": "Hash",
            "p2p.dropzone.text": "Trascina qui i file o clicca per sfogliare",
            "p2p.session.label": "Sessione",
            "p2p.sender.clear": "✕ Rimuovi completati",
            "p2p.sender.send": "▶ Invia",
            "p2p.sender.progressLabel": "Invio in corso",
            "p2p.receiver.senderCode": "Codice del mittente",
            "p2p.receiver.connect": "Connetti ▶",
            "p2p.receiver.downloadFolder": "Cartella di download",
            "p2p.receiver.chooseFolder": "📁 Scegli",
            "p2p.receiver.autoDownload": "Download automatico (nessuna cartella selezionata)",
            "p2p.receiver.deselectFolderTitle": "Deseleziona cartella",
            "p2p.receiver.clearReceived": "✕ Rimuovi ricevuti",
            "p2p.receiver.connectedTo": "Connesso a",
            "p2p.receiver.settingsTitle": "Modifica connessione / cartella",
            "p2p.receiver.settingsBtn": "⚙ impostazioni",
            "p2p.receiver.availableFiles": "File disponibili",
            "p2p.receiver.selectAll": "Seleziona tutto",
            "p2p.receiver.deselectAll": "Deseleziona tutto",
            "p2p.receiver.downloadSelected": "↓ Scarica selezionati",
            "p2p.receiver.waitingFiles": "In attesa di file…",
            "p2p.receiver.connectPrompt": "Connettiti a un mittente per iniziare a ricevere",
            "p2p.receiver.allReceived": "Tutti i file ricevuti!",
            "p2p.receiver.progressLabel": "Ricezione in corso",
            "p2p.server.label": "Server",
            "p2p.server.receiversTitle": "⬇ Destinatari",
            "p2p.server.receiversDesc": "Avanzamento download e verifica ACK",
            "p2p.statusbar.tagline": "WebRTC · Nessun relay · Nessun limite",
            "p2p.tooltip.sender.title": "↑ Modalità Invio",
            "p2p.tooltip.sender.l1": "Condividi i file — il destinatario si connette usando il tuo codice di sessione a 6 caratteri",
            "p2p.tooltip.sender.l2": "I file viaggiano da peer a peer — nulla passa attraverso un server",
            "p2p.tooltip.sender.l3": "Verifica di integrità SHA-256 e ripresa automatica in caso di caduta della connessione",
            "p2p.tooltip.sender.l4": "Un destinatario alla volta — usa la modalità Server per più destinatari",
            "p2p.tooltip.receiver.title": "↓ Modalità Ricezione",
            "p2p.tooltip.receiver.l1": "Inserisci il codice a 6 caratteri fornito dal mittente o dal server per connetterti",
            "p2p.tooltip.receiver.l2": "Scegli una cartella di destinazione — i file vengono salvati direttamente su disco, senza finestre per ogni file",
            "p2p.tooltip.receiver.l3": "Il trasferimento riprende automaticamente se la connessione cade a metà file",
            "p2p.tooltip.receiver.l4": "Funziona sia con peer in modalità Invio sia in modalità Server",
            "p2p.tooltip.server.title": "⊞ Modalità Server",
            "p2p.tooltip.server.l1": "Ospita file che più destinatari possono sfogliare e scaricare contemporaneamente",
            "p2p.tooltip.server.l2": "Ogni destinatario sceglie quali file scaricare — i trasferimenti avvengono in parallelo",
            "p2p.tooltip.server.l3": "Il monitoraggio ACK in tempo reale conferma la ricezione completa di ogni file per client",
            "p2p.tooltip.server.l4": "Aggiungi o rimuovi file in qualsiasi momento — i destinatari connessi vengono avvisati all'istante"
        });

        I18N.registerLang('pt', {
            "app.p2p": "Transferência P2P",
            "p2p.notify.receiverConnected": "Recetor ligado",
            "p2p.notify.receiverDisconnected": "Recetor desligado",
            "p2p.notify.connected": "Ligado ao remetente",
            "p2p.notify.disconnected": "Ligação ao remetente perdida",
            "p2p.notify.serverJoined": "Recetor #{n} ligado",
            "p2p.notify.serverLeft": "Recetor #{n} desligado",
            "p2p.role.title": "SELECIONAR MODO",
            "p2p.role.subtitle": "WebRTC direto · Sem servidor · Sem limite de envio",
            "p2p.role.send.label": "Enviar",
            "p2p.role.send.desc": "Partilhe ficheiros diretamente com um par",
            "p2p.role.receive.label": "Receber",
            "p2p.role.receive.desc": "Transfira de um remetente ou servidor",
            "p2p.role.server.label": "Servidor",
            "p2p.role.server.desc": "Aloje uma biblioteca de ficheiros para vários pares",
            "p2p.role.hint": "Passe o rato ou toque num modo para detalhes · Clique para começar",
            "p2p.role.loading": "A carregar motor P2P…",
            "p2p.role.edgeStrong": "Microsoft Edge recomendado",
            "p2p.role.edgeDesc": " — O Edge suporta a File System Access API, que permite guardar os ficheiros recebidos diretamente numa pasta escolhida, sem diálogos por ficheiro. Outros navegadores utilizarão a transferência clássica por ficheiro.",
            "p2p.common.shaTooltipSend": "Verificar a integridade do ficheiro através de hash SHA-256",
            "p2p.common.shaTooltipSrv": "Calcula e envia o hash SHA-256 aos recetores para verificação da integridade",
            "p2p.table.name": "Nome",
            "p2p.table.size": "Tamanho",
            "p2p.table.status": "Estado",
            "p2p.table.hash": "Hash",
            "p2p.dropzone.text": "Largue os ficheiros aqui ou clique para procurar",
            "p2p.session.label": "Sessão",
            "p2p.sender.clear": "✕ Limpar concluídos",
            "p2p.sender.send": "▶ Enviar",
            "p2p.sender.progressLabel": "A enviar",
            "p2p.receiver.senderCode": "Código do remetente",
            "p2p.receiver.connect": "Ligar ▶",
            "p2p.receiver.downloadFolder": "Pasta de transferência",
            "p2p.receiver.chooseFolder": "📁 Escolher",
            "p2p.receiver.autoDownload": "Transferência automática (sem pasta selecionada)",
            "p2p.receiver.deselectFolderTitle": "Anular seleção da pasta",
            "p2p.receiver.clearReceived": "✕ Limpar recebidos",
            "p2p.receiver.connectedTo": "Ligado a",
            "p2p.receiver.settingsTitle": "Editar ligação / pasta",
            "p2p.receiver.settingsBtn": "⚙ definições",
            "p2p.receiver.availableFiles": "Ficheiros disponíveis",
            "p2p.receiver.selectAll": "Selecionar tudo",
            "p2p.receiver.deselectAll": "Anular seleção",
            "p2p.receiver.downloadSelected": "↓ Transferir selecionados",
            "p2p.receiver.waitingFiles": "A aguardar ficheiros…",
            "p2p.receiver.connectPrompt": "Ligue-se a um remetente para começar a receber",
            "p2p.receiver.allReceived": "Todos os ficheiros recebidos!",
            "p2p.receiver.progressLabel": "A receber",
            "p2p.server.label": "Servidor",
            "p2p.server.receiversTitle": "⬇ Recetores",
            "p2p.server.receiversDesc": "Progresso da transferência e verificação ACK",
            "p2p.statusbar.tagline": "WebRTC · Sem retransmissão · Sem limites",
            "p2p.tooltip.sender.title": "↑ Modo Envio",
            "p2p.tooltip.sender.l1": "Partilha ficheiros — o recetor liga-se usando o seu código de sessão de 6 caracteres",
            "p2p.tooltip.sender.l2": "Os ficheiros viajam de par a par — nada passa por um servidor",
            "p2p.tooltip.sender.l3": "Verificação de integridade SHA-256 e retoma automática se a ligação cair",
            "p2p.tooltip.sender.l4": "Um recetor de cada vez — use o modo Servidor para vários destinatários",
            "p2p.tooltip.receiver.title": "↓ Modo Receção",
            "p2p.tooltip.receiver.l1": "Introduza o código de 6 caracteres fornecido pelo remetente ou servidor para se ligar",
            "p2p.tooltip.receiver.l2": "Escolha uma pasta de destino — os ficheiros são guardados diretamente no disco, sem diálogos por ficheiro",
            "p2p.tooltip.receiver.l3": "A transferência retoma automaticamente se a ligação cair a meio de um ficheiro",
            "p2p.tooltip.receiver.l4": "Funciona tanto com pares em modo Envio como em modo Servidor",
            "p2p.tooltip.server.title": "⊞ Modo Servidor",
            "p2p.tooltip.server.l1": "Aloje ficheiros que vários recetores podem explorar e transferir em simultâneo",
            "p2p.tooltip.server.l2": "Cada recetor escolhe que ficheiros transferir — as transferências correm em paralelo",
            "p2p.tooltip.server.l3": "O acompanhamento ACK em direto confirma a receção completa de cada ficheiro por cliente",
            "p2p.tooltip.server.l4": "Adicione ou remova ficheiros a qualquer momento — os recetores ligados são notificados de imediato"
        });
        ...
        function __p2pEngine() {
            ...
            function attachSenderConn(){
              conn.on('open',function(){
                ...
                startPing();
                updateSendBtn();
                UI.notify({ title: I18N.t('app.p2p'), message: I18N.t('p2p.notify.receiverConnected'), type: 'success', duration: 4000, icon: P2P_ICON });
              });
              ...
              conn.on('close',function(){
                ...
                conn=null;
                UI.notify({ title: I18N.t('app.p2p'), message: I18N.t('p2p.notify.receiverDisconnected'), type: 'warning', duration: 4500, icon: P2P_ICON });
              });
            ...
            function attachReceiverConn(){
              ...
              conn.on('open',function(){
                ...
                UI.notify({ title: I18N.t('app.p2p'), message: I18N.t('p2p.notify.connected'), type: 'success', duration: 4000, icon: P2P_ICON });
              ...
              conn.on('close',function(){
                stopPing();
                // Notifie seulement la PREMIÈRE déconnexion (reconnectAttempts encore à 0
                // à ce stade, avant l'incrémentation ci-dessous) — sinon chaque tentative
                // de reconnexion automatique ratée spammerait une notif toutes les
                // quelques secondes pendant une coupure réseau instable.
                if(reconnectAttempts===0){
                  UI.notify({ title: I18N.t('app.p2p'), message: I18N.t('p2p.notify.disconnected'), type: 'warning', duration: 4500, icon: P2P_ICON });
                }
            ...
            function attachServerConn(c){
              ...
              c.on('open',function(){
                ...
                UI.notify({ title: I18N.t('app.p2p'), message: I18N.t('p2p.notify.serverJoined', { n: c._recvNum }), type: 'success', duration: 4000, icon: P2P_ICON });
                sendFilelistTo(c);
              });
              ...
              c.on('close',function(){
                ...
                UI.notify({ title: I18N.t('app.p2p'), message: I18N.t('p2p.notify.serverLeft', { n: c._recvNum }), type: 'warning', duration: 4000, icon: P2P_ICON });
                if(c._ui){
