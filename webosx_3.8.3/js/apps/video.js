        ...
        I18N.registerLang('it', {
            'vid.dropHint': 'Trascina qui i tuoi file video',
            'vid.noVideo': 'Nessun video',
            'vid.emptyHint': 'Nessun video. Aggiungi un file per iniziare.',
            'vid.fullscreen': 'Schermo intero',
            'vid.previous': 'Precedente',
            'vid.playPause': 'Riproduci/Pausa',
            'vid.next': 'Successivo',
            'vid.repeat': 'Ripeti',
            'vid.playlist': 'Playlist',
            'vid.add': '+ Aggiungi',
            'vid.addFromFiles': 'Da I miei file...',
            'vid.addFromComputer': 'Dal mio computer...',
            'vid.clear': 'Svuota',
            'vid.emptyPlaylist': 'Nessun video. Fai clic su "+ Aggiungi" per importare file video.',
            'vid.remove': 'Rimuovi'
        });
        I18N.registerLang('pt', {
            'vid.dropHint': 'Largue aqui os seus ficheiros de vídeo',
            'vid.noVideo': 'Sem vídeo',
            'vid.emptyHint': 'Sem vídeo. Adicione um ficheiro para começar.',
            'vid.fullscreen': 'Ecrã inteiro',
            'vid.previous': 'Anterior',
            'vid.playPause': 'Reproduzir/Pausar',
            'vid.next': 'Seguinte',
            'vid.repeat': 'Repetir',
            'vid.playlist': 'Lista de reprodução',
            'vid.add': '+ Adicionar',
            'vid.addFromFiles': 'De Os meus ficheiros...',
            'vid.addFromComputer': 'Do meu computador...',
            'vid.clear': 'Limpar',
            'vid.emptyPlaylist': 'Sem vídeos. Clique em "+ Adicionar" para importar ficheiros de vídeo.',
            'vid.remove': 'Remover'
        });
