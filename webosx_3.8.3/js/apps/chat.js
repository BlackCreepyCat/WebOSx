        ...
        I18N.registerLang('it', {
            "app.chat": "Chat",
            "chat.role.title": "Stanza di chat",
            "chat.role.subtitle": "WebRTC diretto · Nessun server · Nessun account",
            "chat.role.create.label": "Crea",
            "chat.role.create.desc": "Avvia una nuova stanza e invita gli amici",
            "chat.role.join.label": "Partecipa",
            "chat.role.join.desc": "Unisciti a una stanza esistente con un codice",
            "chat.setup.pseudoLabel": "Il tuo nome",
            "chat.setup.pseudoPlaceholder": "Nome",
            "chat.setup.encryptLabel": "🔒 Cripta i messaggi",
            "chat.setup.encryptTooltip": "Crittografia end-to-end (AES-256): nemmeno l'host può leggere i messaggi senza la passphrase",
            "chat.setup.passphraseLabel": "Passphrase",
            "chat.setup.passphrasePlaceholder": "Passphrase",
            "chat.setup.errPassphrase": "Inserisci una passphrase",
            "chat.setup.codeLabel": "Codice stanza",
            "chat.setup.codePlaceholder": "XXXXXX",
            "chat.setup.createBtn": "Crea stanza ▶",
            "chat.setup.joinBtn": "Partecipa ▶",
            "chat.setup.back": "◀ Indietro",
            "chat.setup.errPseudo": "Scegli prima un nome",
            "chat.setup.errCode": "Codice non valido — 6 lettere/cifre",
            "chat.room.leave": "Esci",
            "chat.room.participants": "Partecipanti",
            "chat.room.you": "(tu)",
            "chat.room.kick": "Rimuovi dalla stanza",
            "chat.room.composerPlaceholder": "Scrivi un messaggio…",
            "chat.room.send": "Invia",
            "chat.room.locked": "Messaggio cifrato (passphrase errata?)",
            "chat.status.hostReady": "Stanza creata — condividi il codice per invitare",
            "chat.status.connecting": "Connessione alla stanza…",
            "chat.status.connected": "Connesso",
            "chat.status.disconnected": "Disconnesso dalla stanza",
            "chat.status.hostClosed": "L'host ha chiuso la stanza",
            "chat.status.kicked": "Sei stato rimosso dalla stanza",
            "chat.status.connectError": "Connessione non riuscita — controlla il codice",
            "chat.status.full": "Questa stanza è piena",
            "chat.system.joined": "{pseudo} è entrato nella stanza",
            "chat.system.left": "{pseudo} ha lasciato la stanza",
            "chat.system.kicked": "{pseudo} è stato rimosso dalla stanza",
            "chat.copy.copied": "Copiato!",
            "chat.copy.manual": "Copia manualmente"
        });

        I18N.registerLang('pt', {
            "app.chat": "Chat",
            "chat.role.title": "Sala de chat",
            "chat.role.subtitle": "WebRTC direto · Sem servidor · Sem conta",
            "chat.role.create.label": "Criar",
            "chat.role.create.desc": "Inicie uma nova sala e convide amigos",
            "chat.role.join.label": "Entrar",
            "chat.role.join.desc": "Entre numa sala existente com um código",
            "chat.setup.pseudoLabel": "O seu nome",
            "chat.setup.pseudoPlaceholder": "Nome",
            "chat.setup.encryptLabel": "🔒 Encriptar mensagens",
            "chat.setup.encryptTooltip": "Encriptação de ponta a ponta (AES-256): nem sequer o anfitrião consegue ler as mensagens sem a frase-passe",
            "chat.setup.passphraseLabel": "Frase-passe",
            "chat.setup.passphrasePlaceholder": "Frase-passe",
            "chat.setup.errPassphrase": "Introduza uma frase-passe",
            "chat.setup.codeLabel": "Código da sala",
            "chat.setup.codePlaceholder": "XXXXXX",
            "chat.setup.createBtn": "Criar sala ▶",
            "chat.setup.joinBtn": "Entrar ▶",
            "chat.setup.back": "◀ Voltar",
            "chat.setup.errPseudo": "Escolha primeiro um nome",
            "chat.setup.errCode": "Código inválido — 6 letras/dígitos",
            "chat.room.leave": "Sair",
            "chat.room.participants": "Participantes",
            "chat.room.you": "(você)",
            "chat.room.kick": "Remover da sala",
            "chat.room.composerPlaceholder": "Escreva uma mensagem…",
            "chat.room.send": "Enviar",
            "chat.room.locked": "Mensagem encriptada (frase-passe errada?)",
            "chat.status.hostReady": "Sala criada — partilhe o código para convidar",
            "chat.status.connecting": "A ligar à sala…",
            "chat.status.connected": "Ligado",
            "chat.status.disconnected": "Desligado da sala",
            "chat.status.hostClosed": "O anfitrião fechou a sala",
            "chat.status.kicked": "Foi removido da sala",
            "chat.status.connectError": "Não foi possível ligar — verifique o código",
            "chat.status.full": "Esta sala está cheia",
            "chat.system.joined": "{pseudo} entrou na sala",
            "chat.system.left": "{pseudo} saiu da sala",
            "chat.system.kicked": "{pseudo} foi removido da sala",
            "chat.copy.copied": "Copiado!",
            "chat.copy.manual": "Copiar manualmente"
        });
    ...
    <div class="screen" id="chat-screen-room">
      ...
      <div id="chat-statusbar">
        ...
        function __chatEngine() {
            ...
            var MAX_PSEUDO = 18, MAX_MSG = 2000, MAX_PARTICIPANTS = 30, MAX_HISTORY = 300;
            ...
            var hostHistory = [];                  // côté hôte : historique des messages 'msg' déjà relayés
                                                     // (renvoyé en totalité à chaque nouvelle connexion, cf. hostHandleData)
            ...
            // Côté gauche/droite d'un participant : hachage stable de son id, identique
            // pour tout le monde (hôte comme clients) et indépendant de l'ordre de
            // connexion — deux appels avec le même id donnent toujours le même côté.
            function bubbleSide(id) {
                var h = 0;
                id = String(id || '');
            ...
            function renderMessage(msg, mine, text, locked) {
                ...
                var side = bubbleSide(msg.id);
                wrap.className = 'chat-msg ' + (mine ? 'mine' : 'theirs') + ' side-' + side;
                var meta = '<div class="chat-msg-meta">' + escHtml(msg.pseudo) + '</div>';
                wrap.innerHTML = meta
            ...
            function hostHandleData(c, msg) {
                ...
                if (msg.type === 'hello') {
                    ...
                    // On renvoie la totalité de la conversation déjà échangée à ce nouvel
                    // arrivant (et à lui seul : les autres l'ont déjà), avant toute autre chose.
                    try { c.send({ type: 'history', messages: hostHistory }); } catch (e) {}
                    hostBroadcastRoster();
                ...
                if (msg.type === 'msg') {
                    ...
                    hostHistory.push(out);
                    if (hostHistory.length > MAX_HISTORY) hostHistory.shift();
            ...
            function clientHandleData(msg) {
                ...
                if (msg.type === 'history' && Array.isArray(msg.messages)) {
                    // Chaîné séquentiellement (et non en parallèle) pour garantir que les
                    // bulles s'affichent dans l'ordre d'origine malgré le déchiffrement async.
                    msg.messages.reduce(function (chain, m) {
                        return chain.then(function () {
                            if (!m || typeof m.id !== 'string') return;
                            return unpackIncoming(m).then(function (text) {
                                renderMessage(m, m.id === myId, text, false);
                            }).catch(function () {
                                renderMessage(m, m.id === myId, null, true);
                            });
                        });
                    }, Promise.resolve());
                    return;
            ...
            function chatTeardownConnection() {
                ...
                peer = null; hostConn = null; conns = new Map(); hostHistory = [];
