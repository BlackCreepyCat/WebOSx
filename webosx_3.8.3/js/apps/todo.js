        ...
        I18N.registerLang('it', {
            'app.todo': 'Attività',
            'todo.newList': 'Nuova lista', 'todo.newListPrompt': 'Nome della lista:',
            'todo.renameList': 'Rinomina', 'todo.deleteList': 'Elimina lista',
            'todo.deleteListConfirm': 'Eliminare la lista "{name}" e tutte le sue attività?',
            'todo.addItemPlaceholder': "Aggiungi un'attività...",
            'todo.clearCompleted': 'Elimina attività completate',
            'todo.itemsLeft': '{n} rimanenti', 'todo.allDone': 'Tutto fatto!',
            'todo.emptyLists': 'Nessuna lista — creane una per iniziare.',
            'todo.emptyItems': "Nessuna attività. Aggiungine una sopra.",
            'todo.invalidName': 'Nome non valido.',
            'todo.setDueDate': 'Imposta una scadenza', 'todo.dateToday': 'Oggi', 'todo.dateTomorrow': 'Domani',
            'todo.dateYesterday': 'Ieri', 'todo.dateInDays': 'Tra {n}g', 'todo.dateDaysAgo': '{n}g fa',
            'todo.notifyDueToday': '"{text}" ({list}) scade oggi.',
            'todo.notifyOverdue': '"{text}" ({list}) è in ritardo.'
        });
        I18N.registerLang('pt', {
            'app.todo': 'Tarefas',
            'todo.newList': 'Nova lista', 'todo.newListPrompt': 'Nome da lista:',
            'todo.renameList': 'Renomear', 'todo.deleteList': 'Eliminar lista',
            'todo.deleteListConfirm': 'Eliminar a lista "{name}" e todas as suas tarefas?',
            'todo.addItemPlaceholder': 'Adicionar uma tarefa...',
            'todo.clearCompleted': 'Limpar tarefas concluídas',
            'todo.itemsLeft': '{n} restante(s)', 'todo.allDone': 'Tudo concluído!',
            'todo.emptyLists': 'Ainda sem listas — crie uma para começar.',
            'todo.emptyItems': 'Sem tarefas. Adicione uma acima.',
            'todo.invalidName': 'Nome inválido.',
            'todo.setDueDate': 'Definir uma data limite', 'todo.dateToday': 'Hoje', 'todo.dateTomorrow': 'Amanhã',
            'todo.dateYesterday': 'Ontem', 'todo.dateInDays': 'Em {n}d', 'todo.dateDaysAgo': 'Há {n}d',
            'todo.notifyDueToday': '"{text}" ({list}) vence hoje.',
            'todo.notifyOverdue': '"{text}" ({list}) está atrasada.'
        });
