        ...
        const FLAG_SVG = {
            ...
            pt: '<svg viewBox="0 0 3 2" xmlns="http://www.w3.org/2000/svg"><rect width="1.2" height="2" fill="#046A38"/><rect x="1.2" width="1.8" height="2" fill="#DA291C"/><circle cx="1.2" cy="1" r="0.42" fill="#FFCC29"/></svg>'
        };
        const I18N = {
            languages: {
                ...
                it: { name: 'Italiano',  short: 'IT', flag: FLAG_SVG.it, locale: 'it-IT' },
                pt: { name: 'Português', short: 'PT', flag: FLAG_SVG.pt, locale: 'pt-PT' }
            },
            fallback: 'en',
            current: 'fr',
            dict: {},
